...
const app = new Vue({
    ...
    data: {
        ...
        imgCatalogCart: 'https://via.placeholder.com/100x70',
        userSearch: '',
        show: false,
        emptyCart: true,
        emptyCartMessage: "Список товаров пуст",
    },
    methods: {
        getJson(url){
            return fetch(url)
                ...
                .then(data => {
                    if(data.result === 1){
                        ...
                        if(find){
                            ...
                            let firstProduct = {
                                imgSrc: this.imgCatalogCart,
                                id_product: productId,
                                price: +product.price,
                                product_name: product.product_name,
                                quantity: 1
                            };
                            this.cartGoods.push(firstProduct);
